...
using static ObfuscattorLib.Renamer;

namespace ObfuscattorLib.Helpers
{
    public class ReferenceProxyHelper
    {
        ...
        {
            TypeDef ret = new TypeDefUser("ObfuscattorLib", Renamer.GetEndName(RenameMode.Base64, 3, 20), target.CorLibTypes.GetTypeRef("System", "MulticastDelegate"));
