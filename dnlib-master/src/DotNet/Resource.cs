...
namespace dnlib.IO {
	...
	internal sealed class BinaryReaderStream : Stream {
		...
		protected override void Dispose(bool disposing) {
			if (disposing) {
				IBinaryReader binaryReader = reader;
				if (ownsReader && binaryReader != null) {
	...
	public interface IImageStream : IBinaryReader, IDisposable {
...
namespace dnlib.DotNet {
	...
	public class EmbeddedResource : Resource {
		...
		public Stream GetResourceStream() {
			return GetClonedResourceStream().CreateStream(ownsReader: true);
		}
